...
DEBUG:iam_sdk.api:validate login response
...
'''
INFO:iam_sdk.api:requesting user roles
DEBUG:urllib3.connectionpool:Starting new HTTP connection (1): localhost:9000
DEBUG:urllib3.connectionpool:http://localhost:9000 "GET /api/me/roles HTTP/1.1" 200 118
DEBUG:iam_sdk.api:validate my roles response
...
DEBUG:iam_sdk.api:validate my roles response
ERROR:iam_sdk.api:my roles contains invalid response
{
...
File c:\\project\\iam--sdk-python\\iam_sdk\\api.py:122, in Client.list_my_roles(self)
...
File c:\\project\\iam--sdk-python\\iam_sdk\\api.py:176, in Client._validate_api_response(self, api_name, resp)
