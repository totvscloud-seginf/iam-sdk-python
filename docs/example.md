...
client = iam_authn_sdk_python.client(
...
DEBUG:iam_authn_sdk_python.api:validate login response
...
'''
DEBUG:iam_authn_sdk_python.api:requesting validate token
DEBUG:urllib3.connectionpool:Starting new HTTP connection (1): localhost:9000
DEBUG:urllib3.connectionpool:http://localhost:9000 "GET /api/oauth2/introspection HTTP/1.1" 200 459
DEBUG:iam_authn_sdk_python.api:validate introspection response
{'aud': [],
...
DEBUG:iam_authn_sdk_python.api:validate my roles response
ERROR:iam_authn_sdk_python.api:my roles contains invalid response
{
...
c:\\project\\iam-authn-sdk-python\\test.ipynb Cell 8 line <cell line: 1>()
----> <a href='vscode-notebook-cell:/c%3A/project/iam-authn-sdk-python/test.ipynb#X13sZmlsZQ%3D%3D?line=0'>1</a> client.list_my_roles()

File c:\\project\\iam-authn-sdk-python\\iam_authn_sdk_python\\api.py:122, in Client.list_my_roles(self)
...
File c:\\project\\iam-authn-sdk-python\\iam_authn_sdk_python\\api.py:176, in Client._validate_api_response(self, api_name, resp)
